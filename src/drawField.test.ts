...
describe("drawField", () => {
  ...
  it("renders alive field 1x1", () => {
    drawField(el, [[1]], [[1]], onCellClick);
    expect(el.querySelectorAll(".cell").length).toBe(1);
    expect(el.querySelectorAll(".cell.alive").length).toBe(1);
  });

  it("renders shouldDie field 1x1", () => {
    drawField(el, [[1]], [[0]], onCellClick);
    expect(el.querySelectorAll(".cell").length).toBe(1);
    expect(el.querySelectorAll(".cell.shouldDie").length).toBe(1);
  });

  it("renders shouldBorn field 1x1", () => {
    drawField(el, [[0]], [[1]], onCellClick);
    expect(el.querySelectorAll(".cell").length).toBe(1);
    expect(el.querySelectorAll(".cell.shouldBorn").length).toBe(1);
  });
  ...
  it("renders field mxn", () => {
    ...
    drawField(el, field, field, onCellClick);
